      ...
      <div className="profile-container">
        ...
        <div className="profile-telegram">
          <div className="profile-telegram-text">
            Если вам лень заходить на сайт для просмотра домашних заданий то для вас есть телеграм бот в котором легко и быстро можете посмотреть добашнее задание:)
          </div>
          <a
